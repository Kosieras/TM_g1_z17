...
<form method="post" action="worker2.php">
  
    <div class="form-floating">
            <label for="floatingInpu">HOST</label><BR><br>
      
<select name="user" class="form-control" id="floatingInpu"><?php
...
echo "Errno: " . mysqli_connect_errno() . PHP_EOL; echo "Error: " . mysqli_connect_error() . PHP_EOL; exit;
   ...
   $odbiorca = mysqli_query($polaczenie, "Select * from users") or die ("DB error: $dbname");
      ...
      <select name="worker" class="form-control" id="floatingInput">
