...
$dbhost = "localhost";
    ...
    echo "<h2>DZIAŁAJĄCE USŁUGI</h2>";
     echo "<img style='max-height:50px' src='svg/good.svg'/>";
 ...
 $fp = @fsockopen($host, $port, $errno, $errstr, 30);
  if($fp){
    ...
    $stan = "$errno $errstr";
       ...
       echo "<h4><a style='color:red'>$host</a> o porcie $port -> status: <a style='color:green'>$stan</a>";
